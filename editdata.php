<?php
    ...
    if(!isset($_SESSION["editusercorrect"])){
        die("<script>location.href='index.php'</script>");
    }
?>
<!DOCTYPE html>
    ...
    <head>
        ...
        <script>
            ...
            function signin(){
                ...
                if(empty(codf) || empty(lastname) || empty(firstname) || empty(reg) || empty(pro) || empty(com) || empty(via) || empty(civ) || empty(cap) || empty(subplans) || empty(cardnum) || empty(cardscad) || empty(cvv) || empty(email) || empty(confemail)){
                ...
                <form method="post" action="<?=$_SERVER["PHP_SELF"];?>" class="signform" onsubmit="return signin()" name="formsignin">
                    <div class="signpages" id="p1">
                        <div class="inputs">
                            ...
                            <input type="text" maxlength="16" placeholder="Codice Fiscale" name="codf" id="codf" class="signinput"  value="<?= $_SESSION["codf"];?>" disabled>
                            <input type="text" id="lastname" placeholder="Cognome" name="lastname" class="signinput" value="<?= $_SESSION["lastname"];?>">
                            <input type="text" id="firstname" placeholder="Nome" name="firstname" class="signinput" style="margin-right:0;" value="<?= $_SESSION["firstname"];?>"><br>
                            ...
                            <input type="text" name="reg" id="reg" class="signinput" value="Veneto" disabled>
                            <input type="text" id="pro" name="pro" class="signinput" value="Padova" disabled>
                            <select id="com" name="com" class="signinput" style="margin-right:0;">
                                <option><?php if(isset($_POST["com"])){echo $_POST["com"];}else{echo $_SESSION["com"];}?></option>
                            ...
                            <input type="text" placeholder="Via / Viale" name="via" id="via" class="signinput" value="<?= $_SESSION["via"];?>">
                            <input type="text" id="civ" placeholder="Civico" name="civ" class="signinput" value="<?= $_SESSION["civ"];?>">
                            <input type="text" id="cap" placeholder="CAP" name="cap" class="signinput" maxlength="5" style="margin-right:0;" value="<?= $_SESSION["cap"];?>"><br>
                        </div>
                        <p id="warning" class="erroredit"></p>
                        <input type="button" class="btnleft" value="<< Profilo" onclick="location.href='profile.php'">
                    ...
                    <div class="signpages" id="p2" style="display: none;">
                        <div class="inputs">
                            <div class="plans" style="margin-left:2.8vw;">
                                <input type="radio" name="subplans" id="base" value="Base" style="margin-left:5vh;" <?php if($_SESSION["subplan"]==1){echo "checked";}?>><label class="subtitles" for="base"><b>Base</b></label><br>
                                <div class="subplans">
                            ...
                            <div class="plans" style="margin-left:3.8vw;">
                                <input type="radio" name="subplans" id="inter" value="Intermedio" style="margin-left:2.5vh;" <?php if($_SESSION["subplan"]==2){echo "checked";}?>><label class="subtitles" for="inter"><b>Intermedio</b></label><br>
                                <div class="subplans">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#145567"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M16 9v10H8V9h8m-1.5-6h-5l-1 1H5v2h14V4h-3.5l-1-1zM18 7H6v12c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7z"/></svg>
                            ...
                            <div class="plans" style="margin-right:0;margin-left:3.8vw;">
                                <input type="radio" name="subplans" id="avanzato" value="Avanzato" style="margin-left:3vh;" <?php if($_SESSION["subplan"]==3){echo "checked";}?>><label class="subtitles" for="avanzato"><b>Avanzato</b></label><br>
                                <div class="subplans">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#145567"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M16 9v10H8V9h8m-1.5-6h-5l-1 1H5v2h14V4h-3.5l-1-1zM18 7H6v12c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7z"/></svg>
                            ...
                            <input type="text" maxlength="16" placeholder="Numero Carta" name="cardnum" id="carnum" class="signinput" value="<?= $_SESSION["numcard"];?>">
                            <input type="month" id="cardscad" name="cardscad" class="signinput" min="<?=date("Y-m");?>" value="<?= $_SESSION["scadcard"];?>">
                            <input type="text" maxlength="3" id="cvv" placeholder="CVV" name="cvv" class="signinput" style="margin-right:0;" value="<?= $_SESSION["cvv"];?>"><br>
                        </div>
                    ...
                    <div class="signpages" id="p3" style="display: none;">
                        <div class="inputs" style="width:39vw;">
                            ...
                            <input type="email" placeholder="Email" name="email" id="email" class="signinput" style="margin-left:2vw;" value="<?= $_SESSION["email"];?>" disabled>
                            <input type="email" id="confemail" placeholder="Conferma Email" name="confemail" class="signinput" style="margin-right:0;" value="<?= $_SESSION["email"];?>" disabled><br>
                            ...
                            <input type="password" placeholder="Password" name="pass" id="pass" class="signinput" style="margin-left:2vw;" value="<?php if(isset($_POST["pass"])){echo $_POST["pass"];}?>">
                            <input type="password" id="confpass" placeholder="Conferma Password" name="confpass" class="signinput" style="margin-right:0;float:left;" value="<?php if(isset($_POST["confpass"])){echo $_POST["confpass"];}?>">
                    ...
                    <div class="signpages" id="pd" style="display: none;">
                        <div class="inputs">
                            <input type="checkbox" name="privacycookies" id="privacy" class="checkboxes" required checked>
                            <label for="privacy" class="subtitles" style="color:#145567;">Accetto i termini sulla privacy di Waste PD</label><br>
                            <input type="checkbox" name="privacycookies" id="cookies" class="checkboxes" required checked>
                            <label for="cookies" class="subtitles" style="color:#145567;">Acconsento all'uso di cookies per una migliore esperienza</label><br>
                            <input type="checkbox" name="privacycookies" id="quality" class="checkboxes" required checked>
                            <label for="quality" class="subtitles" style="color:#145567;">Ho letto l'informativa su privacy e qualità del sito</label><br>
                            <input type="checkbox" name="privacycookies" id="emailinfo" class="checkboxes" required checked>
                        ...
                        <input type="submit" class="btnright" value="Modifica >>" name="inviomod">
                    </div>
                </form>
            </div>
        </div>
        <?php
            if(isset($_POST["inviomod"])){
                $pass= cleanstr($_POST["pass"]);
                $confpass= cleanstr($_POST["confpass"]);
                if(!(empty($pass) && empty($confpass))){
                    if(empty($pass) || empty($confpass)){
                        die("<script>document.getElementById('warning').innerHTML='* Compila entrambi i campi Password se la vuoi modificare'</script>");
                    }
                    if($pass!=$confpass){
                        die("<script>document.getElementById('warning').innerHTML='* Le password non coincidono'</script>");
                    }
                    changepass($conn, $_SESSION["email"], password_hash($pass, PASSWORD_DEFAULT));
                }
                ...
                edituser($conn, $_SESSION["email"],$lastname, $firstname, $com,$via,$civ,$cap,$subplan,$cardnum,$cardscad,$cvv);
                $_SESSION["editusercorrect"]="";
                die("<script>location.href='message.php?msg=Dati Modificati'</script>");
            }
        ?>
    </body>
</html>